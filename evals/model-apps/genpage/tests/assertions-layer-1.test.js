...
test('agent message contract: passes every upload with escaped structured sections', () => {
  const check = WORKFLOW_ASSERTIONS.get('Every pac model genpage upload records --agent-message with escaped # Agent Thoughts, OOB-style Step-by-Step Processing with bold numbered headings, a bulleted # Summary, and # Final Code sections');
