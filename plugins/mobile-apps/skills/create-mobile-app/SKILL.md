...
| 2 | Planning (3) | [phase-02-planning.md](references/phase-02-planning.md) | Foreground data, native/integration, graph and specs approvals; valid schema/receipt if required |
