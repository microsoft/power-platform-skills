...
3. Ensure `app.json` contains `expo.extra.appInsightsConfig` with customer telemetry disabled and the generated app slug as `appId`. Customer telemetry stays off until the user runs `/setup-app-insights`.
