...
Materialize design + interactive HTML preview + Gates 3-4 → 7-8.5. Apply
auth/data/sample data → 8.85. Offline choice → 9-10. Apply
capabilities/dependencies/tokens/connectors →
