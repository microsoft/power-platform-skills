...
Upload helper              : src/native/cameraUpload.ts  (or "not requested")
...
Note: No native rebuild or permission/config change is performed.
  These are JS wrapper/control changes over template-shipped native modules.
---
```
