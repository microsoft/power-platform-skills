...
and isolated preview. In phone mode reuse configured Player/template auth,
without a new client-registration wizard. Do not fabricate an environment or
client ID, bypass sign-in, or run Dataverse provisioning.
