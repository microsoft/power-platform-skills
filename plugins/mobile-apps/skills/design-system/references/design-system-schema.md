...
Generated: {{ISO 8601 timestamp}} | Personality: {{visual personality}} | Direction: {{explicit direction | product-experience-derived | hybrid(...)}}
...
- Visual personality: {{visual personality}} ({{confidence}})
