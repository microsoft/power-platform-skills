...
### Accent Colors
- **Sentry Purple** (`#6a5fc1`): Primary interactive color — links, pressed states, focus rings
...
- **Glass Dark** (`rgba(54, 22, 107, 0.14)`): Pressed overlay on glass elements
...
- **Button Pressed** (`rgba(0, 0, 0, 0.18) 0px 0.5rem 1.5rem`): Elevated pressed state
...
- Pressed: elevated shadow `rgba(0, 0, 0, 0.18) 0px 0.5rem 1.5rem`
...
- Pressed background: `rgba(54, 22, 107, 0.14)`
...
- Padding: 12px 16px
- Radius: 8px
- Pressed: background transitions to `#6a5fc1`, text to white
...
- **Pressed**: color transitions to `#6a5fc1` (Sentry Purple)
- **Purple links**: `#6a5fc1` default, pressed underline
- **Lime accent links**: `#c2ef4e` default, pressed to `#6a5fc1`
- **Dark context links**: `#362d59`, pressed to `#ffffff`
...
- White text, pressed to Sentry Purple (`#6a5fc1`)
...
| Large Tablet | 768–992px | Full nav visible |
| Large Screen | 992–1152px | Standard layout |
| Large Tablet | 1152–1440px | Max-width content |
...
| Prominent (Level 3) | `rgba(0, 0, 0, 0.18) 0px 0.5rem 1.5rem` | Pressed states, modals |
...
| Large Tablet | 768–992px | Full navigation, side-by-side layouts |
| Large Screen | 992–1152px | Max-width container, full layout |
...
- Interactive: `#6a5fc1` (links/pressed), `#79628c` (buttons)
- Accent: `#c2ef4e` (lime highlight), `#ffb287` (coral focus)
- Border: `#362d59` (dark), `#cfcfdb` (light context)

### Example Component Prompts
- "Create a hero section on deep purple background (#1f1633). Headline at 88px Dammit Sans weight 700, line-height 1.20, white text. Sub-text at 16px Rubik weight 400, line-height 1.50. White solid CTA button (8px radius, 12px 16px padding), pressed transitions to #6a5fc1."
- "Design a navigation bar: transparent over dark background. Rubik 15px weight 500, white text. Uppercase category labels with 0.2px letter-spacing. Pressed color #6a5fc1."
- "Build a primary button: background #79628c, border 1px solid #584674, inset shadow rgba(0,0,0,0.1) 0px 1px 3px, white uppercase text at 14px Rubik weight 700, letter-spacing 0.2px, radius 13px. Pressed: shadow rgba(0,0,0,0.18) 0px 0.5rem 1.5rem."
