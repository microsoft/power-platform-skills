...
**Picked:** <Inspection | Airline | SaaS | Product | Hybrid (...)>
...
background: <dark-slate | crisp-white | cool-gray-light | warm-cream | rich-dark>
...
- `direction` value MUST be one of: `inspection`, `airline`, `saas`, `product`, `hybrid`
