...
| Invoke an existing Power Automate cloud flow | Use Power Apps CLI `app list-flows` / `app add flow` support through the generic connector workflow | `/add-connector` |
