...
| `native-app-plan.md` → `## Design` | foreground creation workflow, deterministically rendered for prototypes or returned through the `real-app-planner` bundle | Human-reviewable Product Experience Contract mirror |
