...
| `/list-connections` | ✅ v0 | Read-only diagnostic — cross-references project connectors with environment connection IDs, flags expired / missing / orphaned. Use when a service call returns 401. |
