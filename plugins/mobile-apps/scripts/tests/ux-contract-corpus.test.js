...
test('Product Experience reports and canonical references have valid local links', () => {
  const files = [
    'docs/product-archetype-architecture-report.md',
    'shared/references/product-experience-contract.md',
    'shared/references/product-archetypes.md',
    'shared/references/visual-personalities.md',
    'shared/references/home-compositions.md',
