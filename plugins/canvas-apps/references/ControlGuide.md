...
Required data-entry controls must satisfy the persistent visible-label contract in
`${PLUGIN_ROOT}/references/LayoutGuide.md`; `AccessibleLabel` and `HintText` do not replace it.
