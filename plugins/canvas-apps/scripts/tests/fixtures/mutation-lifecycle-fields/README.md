# Mutation lifecycle and field-parity fixture

This focused fixture extends the valid Receive/Issue flow with mutation lifecycle evidence
and changed/preserved field ledgers. It proves one stable returned ID across the receipt,
canonical lookup, focused destination, and every post-state field observer.
