...
| --- | --- | --- | --- | --- | --- | --- |
| Create item | btnCreate | `btnCreate.OnSelect: =Set(varCreated, Patch(colItems, Defaults(colItems), {Name: inpEditorValue.Text})); Set(varContinuationId, varCreated.ID); Set(varContinuationMode, "Delete")` | lblDeleteReceipt | Text = varCreated.ID | captures returned ID | PASS |
...
| --- | --- | --- |
| conItemEditor | conItemEditor.Visible: =(varEditorMode = "Edit") = true | PASS |
