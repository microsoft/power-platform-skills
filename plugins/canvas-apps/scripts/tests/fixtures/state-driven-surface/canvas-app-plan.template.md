...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Create item | none | Create | Screen1 | btnCreate.OnSelect | colItems / returned ID | create item and retain continuation | Name | ID | `conItemEditor.Visible=varEditorMode = "Edit"` and title reflects edit state |
| Delete item | continuation active | Delete | Screen1 | btnDelete.OnSelect | colItems / varContinuationId | delete the created item | Existence | ID | canonical and destination absence |
