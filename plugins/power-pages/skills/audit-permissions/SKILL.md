...
- **Fix:** Replace the wildcard using `${PLUGIN_ROOT}/references/webapi-field-allowlist.md`: add each required attribute's exact LogicalName and SchemaName, plus `_<LogicalName>_value` for lookups
