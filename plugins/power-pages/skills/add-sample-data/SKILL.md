...
> **Blast radius if skipped:** Auto-selecting all tables can pollute production-shape tables (e.g. `contact`) with throwaway records.
...
> **Blast radius if skipped:** Inserting hundreds of records can blow past Dataverse storage / API throttling budgets.
> **Cancel leaves:** Nothing — no record inserts yet.
