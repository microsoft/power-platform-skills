...
```bash
node "${CLAUDE_PLUGIN_ROOT}/skills/scan-code/scripts/run-opengrep.js" --projectRoot "<project-root>"
```
...
```bash
node "${CLAUDE_PLUGIN_ROOT}/skills/scan-code/scripts/run-trivy.js" --projectRoot "<project-root>"
```
