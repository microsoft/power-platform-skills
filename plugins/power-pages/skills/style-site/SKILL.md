...
> **Plugin check**: Once per installed plugin version in the current conversation, run `node "${PLUGIN_ROOT}/scripts/check-version.js"`; show/reuse the result.
...
- [Studio capabilities](references/studio-component-capabilities.md): panel availability, not ownership.
- [Placement policy](references/styling-policy.md): expanded scope/source/cascade.
- [Bootstrap/Studio](references/bootstrap-and-studio.md): version/locale uncertainty.
