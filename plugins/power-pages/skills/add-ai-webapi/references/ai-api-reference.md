...
| Lookup reads need the relationship write property too | AI-only reads need `_<LogicalName>_value`. Add the exact Navigation Property only when non-AI code uses it before `@odata.bind`. |
