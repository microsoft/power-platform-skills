...
| `create-site:4.7.plan-approval` | gate | plan | 4.7 | Localized HTML plan rendered in the selected content language — *"Approve and start building / I'd like to make changes"* | nothing |
...
### 6.33 `add-localization` (11 calls)
