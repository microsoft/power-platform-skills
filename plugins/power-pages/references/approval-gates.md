...
| `create-site:1.5.clone-failed` | gate | progress | 1.5 | Packaged SPA clone, cloned website identity inspection, or code-site upload failed — choose retry, from-scratch fallback, or stop | partial-template-clone |
