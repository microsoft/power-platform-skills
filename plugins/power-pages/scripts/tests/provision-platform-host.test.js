  ...
  withMockedHttp(t, [
    {
      ...
      respond: () => ({
        statusCode: 202,
        headers: { location: '/lifecycleOperations/pe-loc', 'retry-after': '1' },
        body: JSON.stringify({ name: 'e1', properties: { provisioningState: 'Creating' } }),
      }),
    },
    {
...
test('rejects a cross-cloud Location header before Platform Host polling', async (t) => {
  ...
  withMockedHttp(t, [
    {
      ...
      respond: () => ({
        statusCode: 202,
        headers: { location: 'https://high.api.bap.microsoft.us/lifecycleOperations/pe-cross-cloud' },
        body: JSON.stringify({ name: 'e1', properties: { provisioningState: 'Creating' } }),
      }),
    },
    {
