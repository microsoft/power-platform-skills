...
//
// Lives in scripts/lib/ alongside the other helpers (moved from scripts/ for
// consistency; a deprecation shim remains at the old path until 2026-07-13).
//
// Usage:
...
const { loadSiteSettings, SITE_SETTING_FILE_SUFFIX } = require('./powerpages-config');
